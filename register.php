        ...
        <div class="relative z-20 w-full max-w-md p-8 bg-white/10 backdrop-blur-sm rounded-xl shadow-lg border border-white/20">
            ...
            <form id="register-form" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" required class="mt-1 block w-full rounded-md border-gray-300 bg-white/20 text-white shadow-sm focus:border-[var(--c-gold)] focus:ring focus:ring-[var(--c-gold)] focus:ring-opacity-50">
                </div>
                <div>
            ...
            <p class="mt-6 text-center text-sm text-gray-300">
                Hai già un account? <a href="login.php" class="font-medium text-[var(--c-gold-bright)] hover:text-[var(--c-gold)]">Accedi</a>
            </p>
        </div>
    </div>
