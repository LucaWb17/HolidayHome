            ...
            <div class="mt-10 bg-[#192233] p-8 rounded-lg border border-[#324467]">
                ...
                <form id="change-password-form" class="space-y-6 max-w-lg mx-auto">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-400">La password deve contenere almeno: 12 caratteri, una lettera maiuscola, una minuscola, un numero e un carattere speciale.</p>
                    </div>
                    <div>
